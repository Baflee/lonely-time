...
describe('UsersService', () => {
    ...
    describe('logIn', () => {
        it('should return response on successful login', async () => {
            ...
            mock.onPost('http://192.168.1.14:3000/users/login', credentials).reply(200, data);
        ...
        it('should handle server response error', async () => {
            ...
            mock.onPost('http://192.168.1.14:3000/users/login', credentials).networkError();
        ...
        it('should handle timeout correctly', async () => {
            const credentials = { email: 'testUser', password: 'testPass' };
            mock.onPost('http://192.168.1.14:3000/users/login', credentials).timeout();
        ...
        it('should handle unexpected errors correctly', async () => {
            const credentials = { email: 'testUser', password: 'testPass' };
            mock.onPost('http://192.168.1.14:3000/users/login', credentials).reply(() => {
    ...
    describe('signUp', () => {
        it('should return response on successful signup', async () => {
            ...
            mock.onPost('http://192.168.1.14:3000/users/signup', credentials).reply(200, data);
        ...
        it('should handle server response error', async () => {
            ...
            const errorResponse = { statusCode: 500, message: 'Erreur interne du serveur' };
            mock.onPost('http://192.168.1.14:3000/users/signup', credentials).networkError();
        ...
        it('should handle timeout correctly', async () => {
            const credentials = { username: 'newUser', password: 'newPass', email: 'test@example.com' };
            mock.onPost('http://192.168.1.14:3000/users/signup', credentials).timeout();
        ...
        it('should handle unexpected errors correctly', async () => {
            const credentials = { username: 'newUser', password: 'newPass', email: 'test@example.com' };
            mock.onPost('http://192.168.1.14:3000/users/signup', credentials).reply(() => {
                throw new Error('Unexpected error');
            });
